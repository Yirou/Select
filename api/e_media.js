...
router.get('/:id', function(req, res) {
    ...
    var id_e_media = parseInt(req.params.id);
    ...
    var query = {limit: answer.limit, offset: answer.offset, where: {id: id_e_media}};
    if (include.length)
        query.include = include;
...
router.put('/:id', function(req, res) {
    ...
    models.E_media.findOne({where: {id: id_e_media}}).then(function(e_media) {
        ...
        // Update e_media
        e_media.update(updateObject, {where: {id: id_e_media}}).then(function() {
            answer["e_media".substring(2)] = e_media;
